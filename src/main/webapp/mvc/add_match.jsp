        ...
        <div class="col-lg-6">
            ...
            <form method="post" action="/mvc/match/add">
                <table class="table">
                    <tr>
                        <td>Player One:</td>
                        <td><input type="text" name="playerOne"></td>
                    </tr>
                    <tr>
                        <td>Player One Score:</td>
                        <td><input type="text" name="playerOneScore"></td>
                    </tr>
                    <tr>
                        <td>Player Two:</td>
                        <td><input type="text" name="playerTwo"></td>
                    </tr>
                    <tr>
                        <td>Player Two Score:</td>
                        <td><input type="text" name="playerTwoScore"></td>
                    </tr>
