        ...
        <div class="col-lg-6">
            ...
            <form method="post" action="/mvc/match/add">
                <table class="table">
                    <tr>
                        <td>Player One:</td>
                        <td><input type="text" name="playerOne" value="<c:out value="${myEdit.playerOne}"/>"></td>
                    </tr>
                    <tr>
                        <td>Player One Score:</td>
                        <td><input type="text" name="playerOneScore" value="<c:out value="${myEdit.playerOneScore}"/>"></td>
                    </tr>
                    <tr>
                        <td>Player Two:</td>
                        <td><input type="text" name="playerTwo" value="<c:out value="${myEdit.playerTwo}"/>"></td>
                    </tr>
                    <tr>
                        <td>Player Two Score:</td>
                        <td><input type="text" name="playerTwoScore" value="<c:out value="${myEdit.playerTwoScore}"/>"></td>
                    </tr>
                    <tr>
                        <td>Date:</td>
